...
(function ($, config, sncLib) {
    ...
    */
    kintone.events.on([
        ...
        if (config.kanriUsers.indexOf(loginUser.code) == -1) {
            // フィールドの表示/非表示設定
            sncLib.nok.util.setMobileAppFieldsShown(cfgMitsumoriFields);
        ...
        if (
            ...
            kintone.mobile.app.record.setFieldShown(cfgMitsumoriFields.meisaiTableNo_T.code, false);
        }
        return event;
    });
    ...
    */
    kintone.events.on([
        ...
        kintone.mobile.app.record.setFieldShown(cfgMitsumoriFields.shohinId_T.code, false);
        return event;
    });
    ...
    kintone.events.on([
        'mobile.app.record.create.change.' + cfgMitsumoriFields.mitsumoriMeisaiTB.code,
        'mobile.app.record.edit.change.' + cfgMitsumoriFields.mitsumoriMeisaiTB.code,
    ], function (event) {
     ...
     */
    kintone.events.on([
        'mobile.app.record.create.change.' + cfgMitsumoriFields.shohinId_T.code,
        'mobile.app.record.edit.change.' + cfgMitsumoriFields.shohinId_T.code,
    ], function (event) {
