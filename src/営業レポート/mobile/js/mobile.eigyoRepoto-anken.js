/**
 * @fileoverview 営業活動レポートの案件情報関連処理（モバイル版）
...
(function ($, config, sncLib) {
	...
	*/
	kintone.events.on([
		'mobile.app.record.create.change.' + cfgEigyoRepotoFields.kakudo.code,
		'mobile.app.record.edit.change.' + cfgEigyoRepotoFields.kakudo.code
	], function (event) {
	...
	*/
	kintone.events.on([
		'mobile.app.record.create.change.' + cfgEigyoRepotoFields.homonkekka.code,
		'mobile.app.record.edit.change.' + cfgEigyoRepotoFields.homonkekka.code
	], function (event) {
		var record = event.record;
	...
	*/
	kintone.events.on([
		'mobile.app.record.create.change.' + cfgEigyoRepotoFields.uriage.code,
		'mobile.app.record.edit.change.' + cfgEigyoRepotoFields.uriage.code
	], function (event) {
		var record = event.record;
	...
	*/
	kintone.events.on([
		'mobile.app.record.create.change.' + cfgEigyoRepotoFields.fukakachi.code,
		'mobile.app.record.edit.change.' + cfgEigyoRepotoFields.fukakachi.code
	], function (event) {
		var record = event.record;
	...
	*/
	kintone.events.on([
		'mobile.app.record.create.change.' + cfgEigyoRepotoFields.juchuyoteibi.code,
		'mobile.app.record.edit.change.' + cfgEigyoRepotoFields.juchuyoteibi.code
	], function (event) {
		var record = event.record;
	...
	*/
	kintone.events.on([
		'mobile.app.record.create.change.' + cfgEigyoRepotoFields.kenshuyoteibi.code,
		'mobile.app.record.edit.change.' + cfgEigyoRepotoFields.kenshuyoteibi.code,
