    ...
    window.msdConfig = window.msdConfig || {
        ...
        dialogs: [
            ...
            // =============================
            {
                ...
                sourceField: 'nok_予実用担当者コード',
                // 自アプリのセット対象サブテーブルフィールドコード
                targetSubtableField: 'nok_担当者TB',
                // 自アプリのセット対象フィールドコード（サブテーブル内のルックアップフィールド限定）
                targetField: 'nok_担当者テーブル_担当者検索',
                // 検索ダイアログの設定
                dialog: {
                    title: '担当者検索ダイアログ',     // タイトル
                ...
                btnConfig: {
                    ...
                    // }
                    searchBtn: {
                        spaceId: 'tantosha_search_btn',
                        id: 'tantoshaSearchBtn',
                        label: '担当者検索'
                    }
                }
            },
